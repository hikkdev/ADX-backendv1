...
- `print-partners` — **not imported** (it reaches `orders`, which notifies
  through this module). PP-1's application door is the
  `PartnerApplicationPort` in `users.ports.ts`, filled in
